...
def get_tools(
    ...
    tools = [
        Tool(
            ...
            description="Anytime further information is needed, or you don't have specific information"
                        " from previus conversations, this tool provides the available information to"

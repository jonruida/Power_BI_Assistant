...
def extract(input_file, output_file):
    ...
    columns=[item["GroupKeys"][0]["Source"]["Property"] for item in data["descriptor"]["Select"] if item["Kind"]==1]
    rest_columns=[item["Value"] for item in data["descriptor"]["Select"] if item["Kind"]==2]
...
def read_json(file_name):
    with open(file_name, 'r', encoding='utf-8') as json_config_file:
